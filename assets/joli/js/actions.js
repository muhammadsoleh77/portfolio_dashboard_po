...
function x_navigation_onresize(){    
    ...
    if(inner_port < 1025){               
        ...
        $('.div-wrapper img').hide();
        $('.div-wrapper-minimize img').hide();
...
function x_navigation_minimize(action){
    ...
    if(action == 'open'){
        ...
        // $(".x-navigation-minimize").find(".div-wrapper").removeClass("img .gambarKecil").addClass("img gambarBesar");

        // $('.div-wrapper img').toggleClass("gambarBesar");
        // $('.div-wrapper-minimize img').toggleClass("gambarKecil");
        $('.div-wrapper img').show();
        $('.div-wrapper-minimize img').hide();

        // $(".div-wrapper").find("img").removeClass(".img_bottom").addClass(".img_bottom2");
        // $('.div-wrapper-minimize img').hide();
    }
    ...
    if(action == 'close'){
        ...
        // $(".div-wrapper img:last-child").remove()

        // $(".x-navigation-minimize").find(".div-wrapper").removeClass("img .gambarBesar").addClass("img .gambarKecil");

        $('.div-wrapper img').hide();
        $('.div-wrapper-minimize img').show();
        // $('.div-wrapper img').toggleClass("gambarBesar");
        // $('.div-wrapper-minimize img').toggleClass("gambarKecil");

        // $('.div-wrapper-minimize img').attr('src');
        // $(".div-wrapper-minimize").append("<img src='../.././assets/joli/img/sidebar_bus2.png' />")
        // $('.div-wrapper-minimize img').show();
    }
