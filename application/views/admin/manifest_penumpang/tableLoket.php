      ...
      <div class="panel panel-default bootstrap-panel">
        <div>
          <div class="panel-body">
            ...
            <?php } else { ?>
              <div  id="dataTable">
                <br><h3>Data Manifest (LOKET)</h3><br>
                ...
                <table class="table table-bordered table-striped">
                  ...
                  <tbody>
                    <?php foreach ($listDataLoket as $loket) { ?>
                      <tr>
                        <td class="text-center"><?php echo $loket->idTransaksi ?></td>
                        <td class="text-center"><?php echo $loket->namaPenumpang ?></td>
                        <td class="text-center"><?php echo $loket->noTelpon ? $loket->noTelpon : "-" ?></td>
                        <td class="text-center"><?php echo $loket->waktu ?></td>
                        <td class="text-center"><?php echo $loket->waktuTransaksi ?></td>
                        <td class="text-center"><?php echo $loket->noTiket ?></td>
                        <td class="text-center"><?php echo $loket->isTransaksiManual ? "Transaksi Dashboard" : "Transaksi Device" ?></td>
                      </tr>
                    <?php } ?>
                  </tbody>
                </table>
