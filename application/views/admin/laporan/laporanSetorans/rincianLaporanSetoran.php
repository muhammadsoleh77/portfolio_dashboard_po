...
<div class="widgets" style="margin-top: 50px;">
    ...
    <ul class="breadcrumb">
        ...
        <li><a href="<?php echo base_url('admin/laporan/laporanSetoran') ?>"><b>Laporan Setoran</b></a></li>
        <li class="active"><b>Rincian</b></li>
    </ul>
    <!-- END BREADCRUMB -->
            ...
            <div class="panel panel-default bootstrap-panel">
                <div class="">
                    <div class="col-md-12">
                        ...
                        <div class="col-md-12">
                            <a href="<?= base_url('admin/laporan/laporanSetoran') ?>" class="btn btn-info" type="button">
